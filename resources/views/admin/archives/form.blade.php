...
<div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden p-4">
    ...
    <form action="{{ isset($archive) ? route('admin.archives.update', $archive) : route('admin.archives.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="flex items-center space-x-4">
            <button type="submit"
                class="ttext-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm text-center me-2 mb-2 px-5 py-2.5">
                Simpan
            </button>
