...
@if(session('error'))
    <div id="alert-error" class="fixed top-20 left-4 right-4 sm:left-auto sm:right-4 sm:max-w-md flex items-center p-4 rounded-lg bg-red-50 dark:bg-gray-800 z-40 border-l-4 border-red-500 shadow-lg animate-alert-enter" role="alert">
        <div class="flex items-center justify-center w-8 h-8 text-red-500 bg-red-100 rounded-lg dark:bg-red-800 dark:text-red-200 flex-shrink-0">
            <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
...
@if ($errors->any())
    <div id="alert-validation" class="fixed top-20 left-4 right-4 sm:left-auto sm:right-4 sm:max-w-md flex p-4 rounded-lg bg-red-50 dark:bg-gray-800 z-40 border-l-4 border-red-500 shadow-lg animate-alert-enter" role="alert">
        <div class="flex items-center justify-center w-8 h-8 text-red-500 bg-red-100 rounded-lg dark:bg-red-800 dark:text-red-200 flex-shrink-0">
            <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
        ...
        <button type="button" class="ms-auto -mx-1.5 -my-1.5 bg-red-50 text-red-500 rounded-lg focus:ring-2 focus:ring-red-400 p-1.5 hover:bg-red-100 inline-flex items-center justify-center h-8 w-8 dark:bg-gray-800 dark:text-red-300 dark:hover:bg-gray-700 flex-shrink-0" data-dismiss-target="#alert-validation" aria-label="Close">
            <span class="sr-only">Tutup</span>
            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
            </svg>
